...
function initCategoryChart(transactions) {
    ...
    const categoryData = getSpendingByCategoryWithColors(transactions);
...
// Get spending by category with colors
function getSpendingByCategoryWithColors(transactions) {
    const categoryMap = {};
